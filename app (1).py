...
OPENROUTER_API_KEY = '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'
...
if uploaded_file is not None or file_option in ["Claim", "Invoice", "Receipt"]:
    if file_option == "Claim":
        ...
        image_path = "D:\DOCXAI\Claims.jpg"
    
         
        
        img = Image.open(image_path)
    elif file_option == "Invoice":
        image_path = "D:\DOCXAI\Invoice.jpeg"  # Replace with actual image path or URL
        img = Image.open(image_path)
    elif file_option == "Receipt":
        image_path = "D:\DOCXAI\Receipt.png"  # Replace with actual image path or URL
        img = Image.open(image_path)
